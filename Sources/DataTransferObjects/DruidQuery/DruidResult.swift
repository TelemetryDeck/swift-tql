...
/// Timeseries queries return an array of JSON objects, where each object represents a value as described in the time-series query.
...
public struct LegacyDruidResultWrapper: Codable {
    ...
    public init(resultType: DruidResultType, timeSeriesResults: [TimeSeriesQueryResultRow]) {
...
public enum QueryResult: Codable, Hashable, Equatable {
    case timeSeries([TimeSeriesQueryResultRow])
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "timeSeriesResult":
            self = .timeSeries(try [TimeSeriesQueryResultRow](from: decoder))
        case "groupByResult":
